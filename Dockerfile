...
COPY main.py runner.py docker_backend.py terminal_bridge.py template_runner.py template_setup_funpay.py github_worker.py private_repo_patch.py github_watch.py sqlite_inspector.py file_manager.py user_discovery.py db_connection.py launcher.py entrypoint.sh ./
COPY sql/ ./sql/
